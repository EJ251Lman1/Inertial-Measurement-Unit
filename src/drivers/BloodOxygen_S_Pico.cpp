...
// The code below is adapted from the DFRobot Heart Rate and Oximeter Sensor V2 library for Raspberry Pi Pico.
// It required to be converted from python to C++ for this project
// Althoug
